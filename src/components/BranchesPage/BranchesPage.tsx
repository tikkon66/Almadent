...
{/* Stepper */}
      <div className="stepper">
        <div className="stepper__item  active">
          <span className="stepper__num">1</span>Филиалы
        </div>
        <div className="stepper__item">
          <span className="stepper__num">2</span>Сотрудники
        </div>
        <div className="stepper__item">
          <span className="stepper__num">3</span>Услуги
        </div>
        <div className="stepper__item">
          <span className="stepper__num">4</span>Записи
        </div>
      </div>
      {/* Список филиалов */}
