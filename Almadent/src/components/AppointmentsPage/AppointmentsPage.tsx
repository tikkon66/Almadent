        ...
        <form style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '10px' }}>
            <div>
              ...
              <input type="text" required value={formData.fullName} onChange={(e) => setFormData({ ...formData, fullName: e.target.value })} style={{ width: '100%' }} />
            </div>
            <div>
              <label>Телефон*</label>
              <input type="text" required value={formData.phone} onChange={(e) => setFormData({ ...formData, phone: e.target.value })} style={{ width: '100%' }} />
            </div>
            <div>
              <label>Email</label>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '10px' }}>
            ...
            <div>
              ...
              <select required value={formData.employeeId} onChange={(e) => setFormData({ ...formData, employeeId: Number(e.target.value) })} style={{ width: '100%' }}>
            ...
            <div>
              <label>Услуга*</label>
              <select required value={formData.serviceId} onChange={(e) => setFormData({ ...formData, serviceId: Number(e.target.value) })} style={{ width: '100%' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '10px' }}>
            ...
            <div>
              ...
              <input type="number" value={formData.duration} onChange={(e) => setFormData({ ...formData, duration: Number(e.target.value) })} style={{ width: '100%' }} />
            </div>
            <div>
              <label>Статус</label>
          ...
          <div>
            ...
            <textarea rows={2} value={formData.comment} onChange={(e) => setFormData({ ...formData, comment: e.target.value })} style={{ width: '100%' }} />
          </div>
          ...
          <div className="grid-header">
            ...
            {viewMode === 'day' && employees.map((emp) => (
              <div key={emp.id} className="employee-card-header">
                <div className="emp-avatar">{emp.full_name ? emp.full_name.charAt(0) : 'E'}</div>
