...
import { createClient, deleteClient, getClients, getClientsCount, updateClient } from '../../service/clients';
          ...
          {activeTab === 'history' && (
            <div className="tab-content">
              <table className="history-table">
                ...
                <tbody>
                  <tr>
                    <td>04.08.2026 14:00</td>
                    <td>Консультация ортодонта</td>
                    <td>Иванов И.И.</td>
                    <td><span className="badge badge--success">Завершен</span></td>
                  </tr>
                  <tr>
                    <td>12.05.2026 10:30</td>
